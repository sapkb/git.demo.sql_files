...
-----3409 person_id
---    421847 payroll_action_id



  
  SELECT   pay.payroll_id id_nomina,--PPA.ELEMENT_SET_ID,PIV.ELEMENT_TYPE_ID,
                    ...
                    (SELECT   pbvv2.VALUE
                      ...
                      WHERE 1=1--  pbvv2.business_group_id = 81
                       ...
                       dias_pagados,
                    0 salario_Base_Cot,
--                     (select PRV1.RESULT_VALUE 
--                     from pay_run_result_values prv1,--pay_element_sets PES
...
--                    ---AND ppe.EMPLOYEE_NUMBER >= NVL (P_EMP_NUM_INI, ppe.EMPLOYEE_NUMBER) AND ppe.EMPLOYEE_NUMBER <= NVL (P_EMP_NUM_FIN, ppe.EMPLOYEE_NUMBER)
         ...
         GROUP BY   pay.payroll_id,
                   ...
                   -- PPA.ELEMENT_SET_ID,PIV.ELEMENT_TYPE_ID
                    --efe
