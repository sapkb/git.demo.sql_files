  ...
  SELECT   id_nomina,
    ...
    FROM   (  SELECT   DISTINCT
                      ...
                      ,ppe.FULL_NAME,
                       ...
                       SUM (TO_NUMBER (prv.result_value)) neto_total
...
----------------------------
SELECT   --pet.*
  pet.element_type_id,SUM (TO_NUMBER (prv.result_value)) importe
                FROM   pay_run_results prr,
                       pay_run_result_values prv,
                       pay_element_types_f pet,
               ...
               WHERE       1 = 1
                      ...
                      and (pet.element_name like 'I9999 NETO') --or pet.element_name like '%INCAP%MATERNIDAD')
              GROUP BY   pay.payroll_id,
                       ptp.time_period_id,
                       ppe.person_id,
